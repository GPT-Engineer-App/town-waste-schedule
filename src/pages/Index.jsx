    ...
    <Container centerContent maxW="container.md" height="100vh" display="flex" flexDirection="column" justifyContent="center" alignItems="center">
      <VStack spacing={4}>
        ...
        <Select placeholder="町を選択" onChange={handleTownChange}>
          {["浅海地区", "新玉地区", "粟井地区", "石井西地区", "石井東地区", "伊台地区", "浮穴地区", "宇和間地区", "小野地区", "小浜地区", "上怒和地区", "久谷地区", "熊田地区", "桑原地区", "河野地区", "神浦地区", "五明地区", "潮見地区", "東雲地区", "清水地区", "生石地区", "素鷲地区", "高浜地区", "立岩地区", "津和地区", "道後地区", "泊地区", "中島粟井地区", "中島大浦地区", "長師地区", "難波地区", "僥地区", "野忽那地区", "畑里地区", "垣生地区", "番町地区", "日浦地区", "久枝地区", "二神地区", "北条地区", "堀江地区", "正岡地区", "味酒地区", "三津浜地区", "味生地区", "宮野地区", "宮前地区", "睦月地区", "元怒和地区", "八坂地区", "雄郡地区", "湯築地区", "湯山地区", "由良地区", "吉木地区", "予土地区", "和気地区"].map((town) => (
